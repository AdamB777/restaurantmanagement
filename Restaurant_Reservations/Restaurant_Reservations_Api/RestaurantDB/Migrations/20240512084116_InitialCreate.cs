    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryStatesDB", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TestCustomersDB",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestCustomersDB", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressesDB_CountryStatesDB_CountryStateId",
                        column: x => x.CountryStateId,
                        principalTable: "CountryStatesDB",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AddressesDB_AddressId",
                        column: x => x.AddressId,
                        principalTable: "AddressesDB",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeAddressesDB",
                columns: table => new
                {
                    EmployeeAdressId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAddressesDB", x => x.EmployeeAdressId);
                    table.ForeignKey(
                        name: "FK_EmployeeAddressesDB_AddressesDB_AddressId",
                        column: x => x.AddressId,
                        principalTable: "AddressesDB",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmployeeAddressesDB_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressesDB_CountryStateId",
                table: "AddressesDB",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAddressesDB_AddressId",
                table: "EmployeeAddressesDB",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAddressesDB_EmployeeId",
                table: "EmployeeAddressesDB",
                column: "EmployeeId");
        }
